...
model = load_model(r"C:\Users\LENOVO\Sistem Cerdas\Sign Language\cnn8grps_rad1_model.h5")
white = np.ones((400, 400), np.uint8) * 255
cv2.imwrite("C:\\Dira\\KULIAHH\\SMT_5\\Sistem_Cerdas\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg", white)
...
while True:
    try:
        ...
        if hands:
            ...
            white = cv2.imread("C:\\Dira\\KULIAHH\\SMT_5\\Sistem_Cerdas\\Sign-Language-To-Text-and-Speech-Conversion-master\\white.jpg")
